...
//Immediately after getting a file object with createFile, we defer the closing
//of that file with closeFile. This will be executed at the end of the enclosing
//function (main), after writeFile has finished.
